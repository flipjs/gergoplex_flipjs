...
LT(SYMB,KC_ESC),    MO(NUMB),           LT(NAVI,KC_SPC),    LT(NAVI,KC_ENT),    MT(MOD_LCTL,KC_BSPC),  MT(MOD_LGUI,KC_DEL)
),
[NAVI] = LAYOUT_gergoplex(
KC_VOLU,  KC_NO,    KC_UP,    KC_NO,         KC_NO,  KC_NO,    KC_NO,    KC_NO,    KC_NO,    KC_NO,
KC_MUTE,  KC_LEFT,  KC_DOWN,  KC_RIGHT,      KC_NO,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_NO,
KC_VOLD,  KC_MPRV,  KC_MPLY,  KC_MNXT,       KC_NO,  KC_MS_L,  KC_MS_D,  KC_MS_U,  KC_MS_R,  KC_NO,
KC_NO,    KC_NO,    KC_SPC,   LGUI(KC_SPC),  KC_NO,  KC_NO
),
...
KC_NO,  KC_NO,  KC_LBRC,  KC_RBRC,  LCTL(KC_N),  KC_GRV,   KC_7,  KC_8,  KC_9,  KC_0,
