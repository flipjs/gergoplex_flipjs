...
MT(MOD_LGUI,KC_DEL),  MT(MOD_LCTL,KC_ESC),  LT(NAVI,KC_SPC),    LT(NUMB,KC_ENT),    LT(SYMB,KC_BSPC),  LT(FUN,KC_TAB)
),
[NAVI] = LAYOUT_gergoplex(
KC_NO,    KC_NO,    KC_NO,    KC_NO,           KC_BTN3,  KC_VOLD,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_VOLU,
KC_NO,    KC_NO,    KC_NO,    KC_NO,           KC_BTN4,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_MUTE,
KC_LSFT,  KC_LALT,  KC_LCTL,  KC_LGUI,         KC_BTN5,  KC_MS_L,  KC_MS_D,  KC_MS_U,  KC_MS_R,  KC_NO,
KC_NO,    KC_NO,    KC_NO,    LGUI(KC_SPC),  KC_BTN1,  KC_BTN2
),
