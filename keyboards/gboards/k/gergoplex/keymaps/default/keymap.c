...
MT(MOD_LSFT,KC_Z),  KC_X,             KC_C,             KC_V,                 MEH_T(KC_B),           MEH_T(KC_N),         KC_M,  KC_COMM,  KC_DOT,  MT(MOD_RSFT,KC_SLSH),
LT(NUMB,KC_TAB),    LT(SYMB,KC_ESC),  LT(NAVI,KC_SPC),  MT(MOD_LCTL,KC_ENT),  MT(MOD_LGUI,KC_BSPC),  MT(MOD_LALT,KC_DEL)
),
